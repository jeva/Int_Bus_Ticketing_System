<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add BusCompany.aspx.cs"
    Inherits="Bus_Website.Add_BusCompany" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Bus Company</title>
    <style type="text/css">
        #Reset1
        {
            width: 67px;
 ...
 <body>
                    ...
                    <li class='has-sub'><a href='#'><span>Trips</span></a>
                        ...
                        <li class='has-sub'><a href='#'><span>Bus Company</span></a>
                            <ul>
                                ...
                                <li class='has-sub'><a href="DeleteBusCompany.aspx"><span>Delete Bus Company </span></a>
                            </ul>
    ...
    <center>
        <font color=" black " size=" 8 ">
            <br />
            <strong>Add Bus Company</strong></font></center>
    <br />
    <br />
    <font color=" black " size=" 5 ">&nbsp;&nbsp;&nbsp;&nbsp; Bus Company ID&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp:</font>
    <asp:TextBox ID="TextBox1" runat="server" Style="margin-left: 40px"></asp:TextBox>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
        ErrorMessage="*Required"></asp:RequiredFieldValidator>
    <br />
    <br />
    <font color=" black " size=" 5 ">&nbsp;&nbsp;&nbsp;&nbsp; Bus Company Name&nbsp;&nbsp;:
    </font>&nbsp;<asp:TextBox ID="TextBox2" runat="server" Style="margin-left: 29px"></asp:TextBox>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Submit" runat="server" Style="margin-left: 85px" Text="Submit" OnClick="Submit_Click" />
