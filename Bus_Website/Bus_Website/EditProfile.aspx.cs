...
namespace Bus_Website.ProfileManagement.EditProfile
{
    public partial class EditProfile : System.Web.UI.Page
    {
        ...
        {/*
            ...
            {
                Firstname.Text = Session["first_name"] .ToString();
            }


                        if (Session["last_name"] != null)
            {
                Lastname.Text = Session["last_name"].ToString();
            }
                        ...
                        if ( Session["email"] != null)
            {
                e_mail.Text = Session["email"].ToString();
                        ...
                        if (Session["ic_num"] != null)
            {
                n_ric.Text = Session["ic_num"].ToString();
            }


                        if (  Session["hp_num"] != null)
            {
                hp_num.Text = Session["hp_num"].ToString();
            }
            ...
            {
                add_ress.Text = Session["address"].ToString();
            }
            */
        }
