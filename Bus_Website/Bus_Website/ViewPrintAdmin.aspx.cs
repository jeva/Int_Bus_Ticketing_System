...
{
    public partial class ViewPrintAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Label8.Text = DropDownList3.SelectedValue.ToString();
                Label6.Text = DropDownList4.SelectedValue.ToString();

            }

            if (Session["ticketID"] != null)
            {
                Label7.Text = Session["ticketID"].ToString();
            }

            if (!IsPostBack)
            {
                SqlCommand cmd = new SqlCommand("Select  Convert (varchar(10) , ticket_date,103) as ticket_date from Ticket where ticket_id = '" + Session["ticketID"] + "'", con);
                ...
                Label9.Text = DropDownList5.SelectedValue.ToString();
...
*/
            ...
            p2.Add(new Chunk("Purchased on : " + Label9.Text + "", arial2));
            ...
            p2.Add(new Chunk("#" + Label7.Text + "", arial));
            ...
            p1.Add(Chunk.NEWLINE);
            p1.Add(new Chunk("No of Adults : " + Label4.Text + "   ", arial2));
            p1.Add(Chunk.NEWLINE);
            p1.Add(Chunk.NEWLINE);
            p1.Add(new Chunk("No of Childs : " + Label8.Text + "   ", arial2));
            p1.Add(Chunk.NEWLINE);
            p1.Add(Chunk.NEWLINE);
            p1.Add(new Chunk("Total Fare (MYR)  : " + Label6.Text + ".00   ", arial));
            p1.Add(Chunk.NEWLINE);
            p1.Add(Chunk.NEWLINE);
            ...
            string fileName = "(" + "#" + Label7.Text + ")" + "-" + "Ticket_Number.pdf";
