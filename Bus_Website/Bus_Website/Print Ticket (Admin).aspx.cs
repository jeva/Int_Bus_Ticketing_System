...
{
    public partial class Print_Ticket__Admin_ : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Label4.Text = Session["adults"].ToString();
            }

            if (Session["childs"] != null)
            {
                Label5.Text = Session["childs"].ToString();
            }

            if (Session["totalfare"] != null)
            {
                Label6.Text = Session["totalfare"].ToString();
            }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            p2.Add(new Chunk("Purchased on : " + Label8.Text + "", arial2));
            ...
            p1.Add(Chunk.NEWLINE);
            p1.Add(Chunk.NEWLINE);
            p1.Add(new Chunk("No of Childs : " + Label5.Text + "   ", arial2));
            p1.Add(Chunk.NEWLINE);
            p1.Add(Chunk.NEWLINE);
